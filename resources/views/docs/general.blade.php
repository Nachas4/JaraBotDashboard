    ...
    <div class="card--body p-3 text-white rounded">
        ...
        <div class="row">
            ...
            <div class="docs-card col-12 col-md-6 mt-4">
                <h3>Getting and Setting the Prefix</h3>

                <div class="card-- mt-3" style="height: fit-content">
                    <div>
                        <div>
                            <h4><b>prefix</b> and <b>setprefix</b></h4>

                            <p>Usage: <span class="usage-example">&prefix</span> and <span class="usage-example">&setprefix
                                    {prefix}</span></p>
                        </div>
                        ...
                        <div>
                            ...
                            <div>This can only be changed by the server owner in the <a
                                    href="{{ route('dashboard') }}">dashboard</a> (or, well, the command).</div>
                        </div>
                    </div>
                </div>
            </div>
