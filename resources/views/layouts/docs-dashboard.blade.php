        ...
        <div class="menu-closed h-100 p-3" style="z-index:10;" id="menu">
            <div class="card-- p-4 h-100 overflow-auto">
                <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    {{-- User Data --}}
                    @auth
                        <div class="card--holder p-3 d-flex align-items-center w-100 rounded mt-3 mb-2" style="height:80px;">
                    ...
                    @guest
                        <div class="card--holder p-3 d-flex align-items-center w-100 rounded mt-3 mb-2"
                            style="height:80px;">
                            <div class="d-flex flex-column justify-content-center h-100 align-items-start text--grey">
                                Not logged in.
                            </div>
